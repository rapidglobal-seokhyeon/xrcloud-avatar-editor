        ...
        try {
            ...
            if (userNo && result) {
                ...
                const res = await axios.post(
                    `${process.env.REACT_APP_SERVER_URL}${process.env.REACT_APP_API_END_POINT}/${userNo}`,
                    formData,
                    {}
                )
                await axios.post(
                    `${process.env.REA}${process.env.REACT_APP_API_END_POINT}/userNo=${userNo}&avatar=${res.data.path}`,
                    {}
                )
